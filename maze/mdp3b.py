...
def sim_action_selection(eps_func, iter_num=1000000):
    si=0
...
plt.plot(sample_num_list, trial_1[0], color="C0", label="$\epsilon=0.1$")
plt.plot(sample_num_list, trial_2[0], color="C1",label="$\epsilon=0.0$")
