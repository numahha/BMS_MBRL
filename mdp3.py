...
def sim_action_selection(eps_func, iter_num=20000000):
    si=0
...
plt.plot(sample_num_list, trial_1[0], color="C0", label="$\epsilon=n^{-1/4}$")
plt.plot(sample_num_list, trial_2[0], color="C1",label="$\epsilon=n^{-1/2}$")
...
plt.legend()
plt.savefig("fig_decay_epsilon.pdf")
plt.close()


plt.plot(np.log(np.array(sample_num_list)), trial_2[0], color="C1",label="$\epsilon=n^{-1/2}$")
for i in range(trial_num-1):
...
plt.plot(np.sqrt(np.array(sample_num_list)), trial_1[0], color="C0",label="$\epsilon=n^{-1/4}$")
for i in range(trial_num-1):
...
'''
#plt.plot(np.log(np.array(sample_num_list)), diff_ml, color="C0", label="$\epsilon=n^{-1/4}$")
plt.plot(np.log(np.array(sample_num_list)), diff_ml2,color="C1", label="$\epsilon=n^{-1/2}$")
plt.xlabel("$\ln(n)$",fontsize=18)
plt.ylabel("ln BF",fontsize=18, labelpad=0)
plt.legend()
plt.savefig("fig_log.pdf")
plt.close()

plt.plot(np.sqrt(np.array(sample_num_list)), diff_ml, color="C0", label="$\epsilon=n^{-1/4}$")
#plt.plot(np.sqrt(np.array(sample_num_list)), diff_ml2, color="C1",label="$\epsilon=n^{-1/2}$")
plt.xlabel("$\sqrt{n}$",fontsize=18)
plt.ylabel("ln BF",fontsize=18, labelpad=-5)
plt.legend()
plt.savefig("fig_sqrt.pdf")
